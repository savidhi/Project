    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="alert alert-primary" role="alert">
                    Total Revenue Generated Rs.<%=amount %>
                </div>
            </div>
            <div class="col"></div>
        </div>
       ...
       <%--  
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="alert alert-primary" role="alert">
                    Total Revenue Generated by Clothing category Rs.<%=clothing %>
                </div>
            </div>
            <div class="col"></div>
        </div>
                        ...
                        for(Order o:oList) {
                            ...
                            for (OrderProducts p : op) {
                                if (p.getCategory().equals("Electronics")) {
                                    int id=o.getOrder_id();
                                    electronics	 += (p.getPrice()*p.getQty());
                                    out.println("<tr><td>" + p.getPid() + "</td>");
                                    out.println("<td>" + p.getName() + "</td>");
                                    out.println("<td>" + p.getPrice() + "</td>");
                                    out.println("<td>" + p.getQty() + "</td>");
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="alert alert-primary" role="alert">
                    Total Revenue Generated by Electronics	 category Rs.<%=electronics	 %>
                </div>
            </div>
            <div class="col"></div>
        </div>
