        ...
        <div class="container-fluid">
            <div class="inner-header">
                ...
                <div class="header-right">
                 <img src="img/icons/search.png" alt="" class="">
			...
			<tbody>
				<c:forEach items="${oList}" var="orders">
					<tr>
						...
						<td><a href="/viewOrderDetailsAdmin?id=<c:out value="${orders.order_id}"/>">View Details</a></td>
						<%-- <td>${string }</td> --%>
						...
						<c:choose>
							<c:when test="${orders.status == 'Approved'}">
								<td><a href="/approve?id=<c:out value="${orders.order_id}"/>"
									class="btn btn-primary disabled" aria-disabled="true">Order
										Confirmed</a></td>
							</c:when>
							<c:when test="${orders.status == 'Disapproved'}">
								<td><a href="/approve?id=<c:out value="${orders.order_id}"/>"
									class="btn btn-danger disabled" aria-disabled="true">Order
										Rejected</a></td>
							</c:when>
							<c:otherwise>
								<td><span> <a
										href="/approve?id=<c:out value="${orders.order_id}"/>"
										class="btn btn-primary">Confirm Order</a> 
										 <a
										href="/disapprove?id=<c:out value="${orders.order_id}"/>"
